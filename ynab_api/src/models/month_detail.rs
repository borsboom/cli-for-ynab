...
impl MonthDetail {
  pub fn new(month: chrono::NaiveDate, categories: Vec<::models::Category>) -> MonthDetail {
    MonthDetail {
      month: month,
      note: None,
      income: None,
  ...
  pub fn with_month(mut self, month: chrono::NaiveDate) -> MonthDetail {
    self.month = month;
    self
  }
  ...
  pub fn with_note(mut self, note: Option<String>) -> MonthDetail {
    self.note = note;
    self
  }
  ...
  pub fn with_income(mut self, income: Option<::models::Milliunits>) -> MonthDetail {
    self.income = income;
    self
  }
  ...
  pub fn with_budgeted(mut self, budgeted: Option<::models::Milliunits>) -> MonthDetail {
    self.budgeted = budgeted;
    self
  }
  ...
  pub fn with_activity(mut self, activity: Option<::models::Milliunits>) -> MonthDetail {
    self.activity = activity;
    self
  }
  ...
  pub fn with_to_be_budgeted(mut self, to_be_budgeted: Option<::models::Milliunits>) -> MonthDetail {
    self.to_be_budgeted = to_be_budgeted;
    self
  }
  ...
  pub fn with_age_of_money(mut self, age_of_money: Option<i32>) -> MonthDetail {
    self.age_of_money = age_of_money;
    self
  }
